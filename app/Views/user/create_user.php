...
<body>
    ...
    <div class="page-container">
        <div class="form-header">
            ...
            <p>Create and manage user accounts with advanced controls</p>
        </div>
                ...
                <div class="form-sections">
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="username" name="Username" class="form-control" placeholder="Username akan terisi otomatis" readonly>
                        </div>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-group">
                            ...
                            <select name="Direct" class="form-control" required>
                                ...
                                <option value="User">User</option>
                                <option value="pusat/dashboard/man">Pusat/Dashboard/Management</option>
                            </select>
                        </div>
                    </div>
                </div>
