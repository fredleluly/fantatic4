        ...
        fetch('dashboard/get-random-data')
            ...
            .then(data => {
                ...
                if (ticketsData.length >= 10) {
                    tableBody.innerHTML = ''; // Hapus semua isi tabel
                    ticketsData = [];         // Reset data array
                    timeLabels = [];          // Reset label waktu
                    resolvedData = [];        // Reset data grafik
                    assignedData = [];
                    counter = 1;              // Reset counter
                    ticketsResolved = 0;      // Reset jumlah resolved
                    ticketsAssigned = 0;      // Reset jumlah assigned
                }
